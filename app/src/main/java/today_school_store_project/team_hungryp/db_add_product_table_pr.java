...
//                    db = dbHelper.getWritableDatabase();
//                    db.execSQL("update prTable set pr_no = "+ editNo.getText().toString() +" where pr_  pr_price = "+ editPrice.getText().toString()+");");
//                    btnSelect.callOnClick();
//                    //db.close();
//                    editNo.setText("");
//                    editName.setText("");
...
//                    db = dbHelper.getWritableDatabase();
//                    db.execSQL("delete from prTable where pr_no ='"+ editNo.getText().toString() +"';");
//                    btnSelect.callOnClick();
//                    //db.close();
//                    editNo.setText("");
//                    editName.setText("");
